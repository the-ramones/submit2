 ...
 */
public class EnterpriseSessionConversationFilter
        implements Filter {

  //  private static Log log = LogFactory.getLog(HibernateSessionConversationFilter.class);
    private static Logger log = Logger.getLogger(EnterpriseSessionConversationFilter.class.getName());
...
//        sf = EnterpriseHibernateUtil.getSessionFactory();
    }
